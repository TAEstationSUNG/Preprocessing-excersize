...
#fx=0.3, fy=0.3 : 가로(fx)와 세로(fy)방향으로 각각 0.3배로 크기 축소
# resized = cv.resize(img, (400, 300))  # 너비 400, 높이 300

# 이미지 화면에 출력
cv.imshow('Image Display', Small_image)  # 'Image Display'라는 이름의 창에 이미지 보여주기
